...
public class FhcTripHotelRoomCreateTest extends TestBase {
    ...
    public void test01() {
        ...
        page.nameKutusu.sendKeys("Alper Kar");
        page.locationKutus.sendKeys("Belcika");
        page.descriptionKutusu.sendKeys("Day 20 olmus");

        Actions actions = new Actions(driver);
        actions.dragAndDrop(page.price500, page.priceKutusu).perform();

        Select select1 = new Select(page.idGroupType);
